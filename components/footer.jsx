  ...
  return (
    ...
    >
      <div className="mx-auto max-w-screen-xl px-4  pb-12 sm:px-6 lg:px-8">
        ...
        >
          <Link href="https://api.whatsapp.com/send?phone=+6281355315427&text=Halo">
            <div className="bg-white p-2 animate-bounce flex items-center rounded-full">
              <div>
                <Image src={wa} width={45} height={45} alt="whatsapp" />
              </div>
              <div>
                <p className="text-gray-800 text-sm mr-5 font-bold">
                  IT Support
                </p>
              </div>
            </div>
